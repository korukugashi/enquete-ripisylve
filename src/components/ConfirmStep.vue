<template>
  ...
  <template v-else-if="step === 2">
    <div class="is-flex" style="align-items: center">
      ...
      <h2 class="ml-3 title is-4 sohoma">Signalement enregistré !</h2>
    </div>
    <p>Nous vous remercions d’avoir contribué à notre enquête !</p>
    ...
    <div class="has-text-centered">
      <a href="/" class="button">Faire une nouveau signalement</a>
    </div>
  </template>
